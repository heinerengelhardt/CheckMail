========================================================================
       MICROSOFT FOUNDATION CLASS BIBLIOTHEK : CheckMail
========================================================================


Diese CheckMail-Anwendung hat der Klassen-Assistent für Sie erstellt. Diese Anwendung
...
Ihre CheckMail-Anwendung bilden.
...
CheckMail.h
	...
	Anwendungsklasse CCheckMailApp.
...
res\CheckMail.ico
	...
	Symbol wird durch die Haupt-Ressourcendatei CheckMail.rc eingebunden.
...
CheckMailDlg.h, CheckMailDlg.cpp - das Dialogfeld
    	Diese Dateien enthalten die Klasse CCheckMailDlg. Diese Klasse legt das
    	Verhalten des Haupt-Dialogfelds der Anwendung fest. Die Vorlage des Dialog-
	felds befindet sich in CheckMail.rc, die mit Microsoft Visual C++
...
StdAfx.h, StdAfx.cpp
	...
	CheckMail.pch und eine vorkompilierte Typdatei mit der Bezeichnung StdAfx.obj
	erstellt.
